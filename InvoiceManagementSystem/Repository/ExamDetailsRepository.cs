...
namespace InvoiceManagementSystem.Repository
{
    public class ExamDetailsRepository : IExamDetailsRepository
    {
        ...
        public ExamModel GetAllExamDetails(ExamModel model)
        {
            try
            {
                int TotalEntries = 0;
                ...
                int startentries = 0;
                List<ExamModel> lstExamDetailsList = new List<ExamModel>();
                conn.Open();
                ...
                if (dt != null && dt.Rows.Count > 0)
                {
                    ...
                    for (var i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        lstExamDetailsList.Add(obj);
                    }
                }
                model.LSTExamList = lstExamDetailsList;
        ...
        public ExamModel GetSingleExamDetails(ExamModel cls)
        {
            try
            {
        ...
        public string UpdateStatus(ExamModel cls)
        {
            ...
            try
            {
                ...
                conn.Open();
                SqlCommand cmd = new SqlCommand("sp_UpdateExamDetailsStatus", conn);
        ...
        public DataTable ExportExamDetails(ExamModel cls)
        {
            try
            {
                List<ExamModel> LSTList = new List<ExamModel>();
