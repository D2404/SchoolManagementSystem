...
function drawBasic() {
  ...
  if ($("#combo-chart").length > 0) {
      var data = google.visualization.arrayToDataTable([
        ['Month', 'Total Limit Allocation', 'Total Expenditure', 'Total Unspent Balance' ],
        ['Jan',  93800,      16500,         77300,            ],
        ['Feb',  35000,      11200,         23800,            ],
        ['Mar',  57000,      16000,         41000,            ],
        ['Apr',  80000,      20000,         60000,            ],
        ['May',  50000,      24000,         26000,            ],
        ['Jun',  100000,     58000,         42000,            ]
      ]);
      var options = {
